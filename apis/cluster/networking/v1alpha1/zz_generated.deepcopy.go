...
func (in *DomainsObservation) DeepCopyInto(out *DomainsObservation) {
	*out = *in
	...
	if in.SSLValidationErrorReasons != nil {
		in, out := &in.SSLValidationErrorReasons, &out.SSLValidationErrorReasons
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.VerificationErrorReasons != nil {
		in, out := &in.VerificationErrorReasons, &out.VerificationErrorReasons
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlbSettingsInitParameters) DeepCopyInto(out *GlbSettingsInitParameters) {
	*out = *in
	if in.Cdn != nil {
	...
	if in.RegionPriorities != nil {
		in, out := &in.RegionPriorities, &out.RegionPriorities
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlbSettingsInitParameters.
func (in *GlbSettingsInitParameters) DeepCopy() *GlbSettingsInitParameters {
	if in == nil {
		return nil
	}
	out := new(GlbSettingsInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlbSettingsObservation) DeepCopyInto(out *GlbSettingsObservation) {
	*out = *in
	if in.Cdn != nil {
		in, out := &in.Cdn, &out.Cdn
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlbSettingsObservation.
func (in *GlbSettingsObservation) DeepCopy() *GlbSettingsObservation {
	if in == nil {
		return nil
	}
	out := new(GlbSettingsObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GlbSettingsParameters) DeepCopyInto(out *GlbSettingsParameters) {
	*out = *in
	if in.Cdn != nil {
		in, out := &in.Cdn, &out.Cdn
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GlbSettingsParameters.
func (in *GlbSettingsParameters) DeepCopy() *GlbSettingsParameters {
	if in == nil {
		return nil
	}
	out := new(GlbSettingsParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InboundRuleInitParameters) DeepCopyInto(out *InboundRuleInitParameters) {
	*out = *in
	...
	if in.SourceTagsRefs != nil {
		in, out := &in.SourceTagsRefs, &out.SourceTagsRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.SourceTagsSelector != nil {
		in, out := &in.SourceTagsSelector, &out.SourceTagsSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *LoadbalancerInitParameters) DeepCopyInto(out *LoadbalancerInitParameters) {
	*out = *in
	...
	if in.GlbSettings != nil {
		in, out := &in.GlbSettings, &out.GlbSettings
		*out = make([]GlbSettingsInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TargetLoadBalancerIds != nil {
		in, out := &in.TargetLoadBalancerIds, &out.TargetLoadBalancerIds
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *LoadbalancerObservation) DeepCopyInto(out *LoadbalancerObservation) {
	*out = *in
	...
	if in.GlbSettings != nil {
		in, out := &in.GlbSettings, &out.GlbSettings
		*out = make([]GlbSettingsObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LoadbalancerParameters) DeepCopyInto(out *LoadbalancerParameters) {
	*out = *in
	...
	if in.GlbSettings != nil {
		in, out := &in.GlbSettings, &out.GlbSettings
		*out = make([]GlbSettingsParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *OutboundRuleInitParameters) DeepCopyInto(out *OutboundRuleInitParameters) {
	*out = *in
	...
	if in.DestinationTagsRefs != nil {
		in, out := &in.DestinationTagsRefs, &out.DestinationTagsRefs
		*out = make([]v1.Reference, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.DestinationTagsSelector != nil {
		in, out := &in.DestinationTagsSelector, &out.DestinationTagsSelector
		*out = new(v1.Selector)
		(*in).DeepCopyInto(*out)
	}
	if in.PortRange != nil {
