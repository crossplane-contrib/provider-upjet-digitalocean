...
func (mg *RegistryDockerCredentials) GetTerraformResourceType() string {
	return "digitalocean_container_registry_docker_credentials"
}
...
func (tr *RegistryDockerCredentials) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"docker_credentials": "status.atProvider.dockerCredentials"}
}
...
// GetInitParameters of this RegistryDockerCredentials
func (tr *RegistryDockerCredentials) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this RegistryDockerCredentials using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RegistryDockerCredentials) LateInitialize(attrs []byte) (bool, error) {
	params := &RegistryDockerCredentialsParameters{}
