...
func (tr *App) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"spec[*].env[*].value": "spec[*].env[*].valueSecretRef", "spec[*].function[*].env[*].value": "spec[*].function[*].env[*].valueSecretRef", "spec[*].job[*].env[*].value": "spec[*].job[*].env[*].valueSecretRef", "spec[*].service[*].env[*].value": "spec[*].service[*].env[*].valueSecretRef", "spec[*].static_site[*].env[*].value": "spec[*].staticSite[*].env[*].valueSecretRef", "spec[*].worker[*].env[*].value": "spec[*].worker[*].env[*].valueSecretRef"}
}
