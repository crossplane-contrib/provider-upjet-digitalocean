...
type DomainInitParameters_2 struct {
...
type DomainObservation_2 struct {
...
type DomainParameters_2 struct {
...
type DomainSpec struct {
	...
	ForProvider     DomainParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DomainInitParameters_2 `json:"initProvider,omitempty"`
}

// DomainStatus defines the observed state of Domain.
type DomainStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DomainObservation_2 `json:"atProvider,omitempty"`
}
