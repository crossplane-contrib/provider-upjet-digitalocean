...
type ReplicaInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	PrivateNetworkUUIDRef *v1.NamespacedReference `json:"privateNetworkUuidRef,omitempty" tf:"-"`

	// Selector for a VPC in vpc to populate privateNetworkUuid.
	// +kubebuilder:validation:Optional
	PrivateNetworkUUIDSelector *v1.NamespacedSelector `json:"privateNetworkUuidSelector,omitempty" tf:"-"`
