...
type InboundRuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	SourceTagsRefs []v1.NamespacedReference `json:"sourceTagsRefs,omitempty" tf:"-"`

	// Selector for a list of Tag in digitalocean to populate sourceTags.
	// +kubebuilder:validation:Optional
	SourceTagsSelector *v1.NamespacedSelector `json:"sourceTagsSelector,omitempty" tf:"-"`
}
...
type OutboundRuleInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DestinationTagsRefs []v1.NamespacedReference `json:"destinationTagsRefs,omitempty" tf:"-"`

	// Selector for a list of Tag in digitalocean to populate destinationTags.
	// +kubebuilder:validation:Optional
	DestinationTagsSelector *v1.NamespacedSelector `json:"destinationTagsSelector,omitempty" tf:"-"`
