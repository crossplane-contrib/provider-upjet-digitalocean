...
type ForwardingRuleInitParameters struct {
	...
	// The unique name of the TLS certificate to be used for SSL termination.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-digitalocean/apis/namespaced/networking/v1alpha1.Certificate
	CertificateName *string `json:"certificateName,omitempty" tf:"certificate_name,omitempty"`

	// Reference to a Certificate in networking to populate certificateName.
	// +kubebuilder:validation:Optional
	CertificateNameRef *v1.NamespacedReference `json:"certificateNameRef,omitempty" tf:"-"`

	// Selector for a Certificate in networking to populate certificateName.
	// +kubebuilder:validation:Optional
	CertificateNameSelector *v1.NamespacedSelector `json:"certificateNameSelector,omitempty" tf:"-"`
...
type LoadbalancerInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	DropletIdsRefs []v1.NamespacedReference `json:"dropletIdsRefs,omitempty" tf:"-"`

	// Selector for a list of Droplet in droplet to populate dropletIds.
	// +kubebuilder:validation:Optional
	DropletIdsSelector *v1.NamespacedSelector `json:"dropletIdsSelector,omitempty" tf:"-"`
