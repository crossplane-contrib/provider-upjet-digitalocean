...
type CdnInitParameters struct {
	...
	BucketDomainName *v1.NamespacedSelector `json:"bucketDomainName,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-digitalocean/apis/namespaced/dns/v1alpha1.Domain
	...
	// +kubebuilder:validation:Optional
	CustomDomainRef *v1.NamespacedReference `json:"customDomainRef,omitempty" tf:"-"`

	// A unique ID that can be used to identify and reference a CDN Endpoint.
	ID *v1.NamespacedSelector `json:"id,omitempty" tf:"-"`

	// Selector for a Certificate in networking to populate certificateName.
	// +kubebuilder:validation:Optional
	Name *v1.NamespacedSelector `json:"name,omitempty" tf:"-"`

	// The fully qualified domain name, (FQDN) for a Space.
	// fully qualified domain name (FQDN) for the origin server
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-digitalocean/apis/namespaced/spaces/v1alpha1.Bucket
	...
	// +kubebuilder:validation:Optional
	OriginRef *v1.NamespacedReference `json:"originRef,omitempty" tf:"-"`
