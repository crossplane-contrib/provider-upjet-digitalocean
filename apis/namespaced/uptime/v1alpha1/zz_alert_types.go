...
type AlertInitParameters struct {
	...
	// A unique identifier for a check.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-digitalocean/apis/namespaced/uptime/v1alpha1.Check
	CheckID *string `json:"checkId,omitempty" tf:"check_id,omitempty"`

	// Reference to a Check in uptime to populate checkId.
	// +kubebuilder:validation:Optional
	CheckIDRef *v1.NamespacedReference `json:"checkIdRef,omitempty" tf:"-"`

	// Selector for a Check in uptime to populate checkId.
	// +kubebuilder:validation:Optional
	CheckIDSelector *v1.NamespacedSelector `json:"checkIdSelector,omitempty" tf:"-"`
