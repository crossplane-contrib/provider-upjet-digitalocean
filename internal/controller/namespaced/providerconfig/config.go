...
import (
	...
	"github.com/crossplane-contrib/provider-upjet-digitalocean/apis/namespaced/v1beta1"
)
...
// SetupGated registers gated setup for namespaced provider config controllers.
